...
namespace ego_planner
{
  ...
  private:
    ...
    double goal_arrival_xy_tolerance_, goal_arrival_z_tolerance_;
    double goal_arrival_max_xy_speed_, goal_arrival_max_z_speed_;
    ...
    ros::ServiceServer planning_enable_srv_;
    ...
    void outputWaypointCallback(const geometry_msgs::PoseStampedPtr &msg);
    ...
    bool setPlanningEnabledCallback(std_srvs::SetBool::Request &req, std_srvs::SetBool::Response &res);
